...
function bones_register_sidebars() {
    register_sidebar(array(
        'id' => 'sidebar-top-area',
        'name' => __('Widget Area Top', 'bonestheme'),
        'description' => __('Widget in top area', 'bonestheme'),
    ...
    register_sidebar(array(
        ...
        'name' => __('Sidebar Single Post', 'bonestheme'),
        'description' => __('The sidebar for single posts.', 'bonestheme'),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h4 class="widgettitle">',
        'after_title' => '</h4>',
    ...
    register_sidebar(array(
        ...
        'description' => __('The first (primary) footer widget.', 'bonestheme'),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h4 class="widgettitle">',
        'after_title' => '</h4>',
    ...
    register_sidebar(array(
        ...
        'description' => __('The second (secondary) footer widget.', 'bonestheme'),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h4 class="widgettitle">',
        'after_title' => '</h4>',
    ...
    register_sidebar(array(
        ...
        'description' => __('The third (tertiary) footer widget.', 'bonestheme'),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h4 class="widgettitle">',
        'after_title' => '</h4>',
        ...
        <article id="comment-<?php comment_ID(); ?>" class="clearfix">
            <header class="comment-author vcard">
                ...
                */
                ...
                <?php printf(__('<cite class="fn">%s</cite>', 'bonestheme'), your_get_comment_author_link()) ?>
...
function bones_wpsearch($form) {
    $form = '<div class="search-form"><form role="search" method="get" id="searchform" action="' . home_url( '/' ) . '" >
